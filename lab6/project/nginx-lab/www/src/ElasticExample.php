    ...
    private function addSampleProducts()
    {
        $products = [
            ...
            [
                ...
                'description' => 'Книга по программированию на языке PHP для начинающих',
                'price' => 2499.99,
                'category' => 'books'
            ],
            [
                'name' => 'Книга Альбер Камю "Миф о сизифе"',
                'description' => 'Книга французского философа с рассуждениями о смысле жизни и абсурдности мира',
                'price' => 2499.99,
                'category' => 'books'
            ]
        ];
